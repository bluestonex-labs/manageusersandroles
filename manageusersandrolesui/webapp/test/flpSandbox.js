		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ukcobrakesrfmanageusersandrolesui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ukcobrakesrfmanageusersandrolesui-display": {
								"semanticObject": "ukcobrakesrfmanageusersandrolesui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uk.co.brakes.rf.manageusersandrolesui",
									"url": sap.ui.require.toUrl("uk/co/brakes/rf/manageusersandrolesui")
								}
							}
						}
					}
